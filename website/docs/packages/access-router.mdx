...
```ts
(this: express.Request, value: ModelDocument<unknown>, permissions: Permissions, context: ModelHookContext) =>
...
```ts
(this: express.Request, allowedData: unknown, permissions: Permissions, context: ModelHookContext) => boolean | unknown[] | Promise<boolean | unknown[]>
```
...
```ts
(this: express.Request, value: unknown, permissions: Permissions, context: ModelHookContext) =>
...
```ts
(this: express.Request, doc: unknown, permissions: Permissions, context: ModelHookContext) =>
