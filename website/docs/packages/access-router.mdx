...
- access and query shaping: `routeGuard`, `overrideFilter`, `baseFilter`
- pre-write: `validate`, `prepare`, `transform`
- post-persist: `afterPersist`
- update diff side effects: `change`
...
- create: `routeGuard -> validate -> prepare -> create -> afterPersist -> docPermissions -> decorate`
- update: `routeGuard -> overrideFilter/baseFilter -> validate -> prepare -> transform -> save -> afterPersist -> change -> docPermissions -> decorate`
- delete: `routeGuard -> overrideFilter/baseFilter -> beforeDelete -> delete -> afterDelete`
- read/list: `routeGuard -> overrideFilter/baseFilter -> docPermissions -> decorate -> decorateAll`
