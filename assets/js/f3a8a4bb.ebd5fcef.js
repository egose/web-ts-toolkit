"use strict";
(globalThis["webpackChunkwebsite"] ||= []).push([[994],{
...
const toc = [{
  ...
  "value": "Revert-clean semantics",
  "id": "revert-clean-semantics",
  "level": 3
}, {
  "value": "Nested-edit contract",
  "id": "nested-edit-contract",
  "level": 3
}, {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        ...
        children: "track which top-level fields changed (modified state is auto-reconciled against the snapshot, so reversing a change cleans the field)"
      ...
      children: [(0,jsx_runtime.jsx)(_components.code, {
        children: "Model<T>"
      }), " tracks modified top-level paths and reconciles every write against the loaded or last successfully saved snapshot."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The snippets in this section all assume a successful read — i.e. they live inside the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "if (read.success) { ... }"
      }), " narrowing shown in ", (0,jsx_runtime.jsx)(_components.a, {
        href: "#basic-usage",
        children: "Basic Usage"
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        ...
        }), " (see the ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "Nested-edit contract"
        }), " below)"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["reverting a top-level field to its snapshot baseline clears the dirty flag, so ", (0,jsx_runtime.jsx)(_components.code, {
          children: "A -> B -> A"
        }), " (or ", (0,jsx_runtime.jsx)(_components.code, {
          children: "set('x', snap) -> set('x', diff) -> set('x', snap)"
        }), ") leaves the field clean"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "revert-clean-semantics",
      children: "Revert-clean semantics"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["When you call ", (0,jsx_runtime.jsx)(_components.code, {
        children: "set(...)"
      }), ", ", (0,jsx_runtime.jsx)(_components.code, {
        children: "assign(...)"
      }), ", or assign a top-level field via the property setter, the model compares the new value to the snapshot using deep equality. If they match, the path is removed from the dirty set. This applies whether the write produced a different value or simply re-wrote the same value:"]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-ts",
      ...
      children: ["Direct mutation of nested objects and arrays is ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "not"
      }), " tracked by the model:"]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-ts",
        children: "user.data.statusHistory[0].label = 'approved';\n\nuser.data.isDirty('statusHistory');\n// false — direct nested writes bypass the dirty tracker\n\nuser.data.statusHistory.push({ label: 'extra', flag: 'red' });\nuser.data.isDirty('statusHistory');\n// false — array methods (push, splice, etc.) bypass the dirty tracker too\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "This behavior is intentional, not a silent unsupported feature. The model deliberately avoids a recursive Proxy over nested values because recursive proxies introduce unstable identity, break common equality checks, and obscure which top-level fields will be persisted."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "To track a nested edit, use one of:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: [(0,jsx_runtime.jsx)(_components.code, {
          children: "set('path.to.field', value)"
        }), " — applies the write and reconciles the top-level field against the snapshot"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: [(0,jsx_runtime.jsx)(_components.code, {
          children: "markModified('topLevelField')"
        }), " after a direct mutation — flags the top-level field dirty without reconciling, so the next ", (0,jsx_runtime.jsx)(_components.code, {
          children: "save()"
        }), " includes it"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-ts",
        children: "user.data.set('statusHistory.0.label', 'approved');\nuser.data.isDirty('statusHistory'); // true\n\n// or, equivalently, mutate directly and opt in to tracking:\nuser.data.statusHistory[0].label = 'approved';\nuser.data.markModified('statusHistory');\nuser.data.isDirty('statusHistory'); // true\n"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["If you forget to opt in, ", (0,jsx_runtime.jsx)(_components.code, {
        children: "save()"
      }), " will not include the field and the server will not see the change — the change is \"lost\" on save, not silently applied. Tests assert this so the contract cannot silently regress."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Example:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["an ID-based read retains its persistence identity even when the projection\nexcludes ", (0,jsx_runtime.jsx)(_components.code, {
          children: "_id"
        }), ", so ", (0,jsx_runtime.jsx)(_components.code, {
          children: "save()"
        }), " still updates the original route"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["if ", (0,jsx_runtime.jsx)(_components.code, {
          children: "_id"
        }), " and captured persistence identity are both missing on a draft,\n", (0,jsx_runtime.jsx)(_components.code, {
          children: "save()"
        }), " calls ", (0,jsx_runtime.jsx)(_components.code, {
          children: "service.create(...)"
        })]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["if the wrapper represents an existing document but has no recoverable\nidentity, ", (0,jsx_runtime.jsx)(_components.code, {
          children: "save()"
        ...
        children: ["on success, the model snapshot is replaced with the latest persisted state and the dirty set is cleared, except for top-level fields you concurrently re-edited while the request was in flight (those fields retain their newer local value and stay dirty so the next ", (0,jsx_runtime.jsx)(_components.code, {
          children: "save()"
        }), " re-sends them)"]
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
      ...
      children: ["Import ", (0,jsx_runtime.jsx)(_components.code, {
        children: "MissingPersistenceIdentityError"
      }), " from the package root when a projected\nfilter/list read may intentionally omit ", (0,jsx_runtime.jsx)(_components.code, {
        children: "_id"
      }), " and you need to handle that case."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Example:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        ...
        children: "you want dirty tracking to reflect the change immediately and reconcile against the snapshot"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Use ", (0,jsx_runtime.jsx)(_components.code, {
        children: "markModified(...)"
        ...
        children: "save()"
      }), " to include the top-level field. ", (0,jsx_runtime.jsx)(_components.code, {
        children: "markModified(...)"
      }), " also serves as the explicit opt-in to send a top-level field even when its effective value matches the snapshot."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
